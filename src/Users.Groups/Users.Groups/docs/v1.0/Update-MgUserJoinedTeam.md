...
```
Update-MgUserJoinedTeam -TeamId <String> -UserId <String> [-AdditionalProperties <Hashtable>]
 [-Channels <IMicrosoftGraphChannel[]>] [-Classification <String>] [-Description <String>]
 [-DisplayName <String>] [-FunSettings <IMicrosoftGraphTeamFunSettings>] [-Group <IMicrosoftGraphGroup>]
 [-GuestSettings <IMicrosoftGraphTeamGuestSettings>] [-Id <String>]
 [-InstalledApps <IMicrosoftGraphTeamsAppInstallation[]>] [-InternalId <String>] [-IsArchived]
 [-Members <IMicrosoftGraphConversationMember[]>] [-MemberSettings <IMicrosoftGraphTeamMemberSettings>]
 ...
 [-Schedule <IMicrosoftGraphSchedule>] [-Specialization <String>] [-Template <Hashtable>]
 [-Visibility <String>] [-WebUrl <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```
Update-MgUserJoinedTeam -InputObject <IUsersGroupsIdentity> [-AdditionalProperties <Hashtable>]
 [-Channels <IMicrosoftGraphChannel[]>] [-Classification <String>] [-Description <String>]
 [-DisplayName <String>] [-FunSettings <IMicrosoftGraphTeamFunSettings>] [-Group <IMicrosoftGraphGroup>]
 [-GuestSettings <IMicrosoftGraphTeamGuestSettings>] [-Id <String>]
 [-InstalledApps <IMicrosoftGraphTeamsAppInstallation[]>] [-InternalId <String>] [-IsArchived]
