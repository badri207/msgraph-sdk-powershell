...
online version: https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users.groups/get-mguserjoinedgroup
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-MgUserJoinedGroup -InputObject <IUsersGroupsIdentity> [-ExpandProperty <String[]>] [-Property <String[]>]
 [<CommonParameters>]
```
